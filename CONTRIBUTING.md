...
:tada: Thank you for being interested in contributing to the SNARK artifacts project! :tada:
...
The best way to contribute to our projects is by opening a [new issue](https://github.com/privacy-scaling-explorations/snark-artifacts/issues/new/choose) or tackling one of the issues listed [here](https://github.com/privacy-scaling-explorations/snark-artifacts/contribute).
...
6. Use `pnpm changeset` to add a changeset for packages that are modified and require a new version release (the changeset bot will remind you anyway, [see](https://github.com/privacy-scaling-explorations/snark-artifacts/pull/63#issuecomment-2122290493)).
